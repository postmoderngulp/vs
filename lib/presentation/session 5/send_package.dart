...
import 'package:vs1/domain/session%203/send_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        onChanged: (value) => model.packageInfo.package.weight = value,
        cursorColor: colors.main,
        decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 12.h),
          border: InputBorder.none,
    ...
    return Container(
      ...
      child: TextField(
        style: Theme.of(context).brightness == Brightness.dark
            ...
            : fontStyle.labelBlack,
        keyboardType: TextInputType.number,
        onChanged: (value) => model.packageInfo.package.worthItems = value,
        cursorColor: colors.main,
        decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(horizontal: 8.w, vertical: 12.h),
          border: InputBorder.none,
...
class OriginPhone extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        keyboardType: TextInputType.number,
        onChanged: (value) => model.packageInfo.originDetail.number = value,
        cursorColor: colors.main,
        style: Theme.of(context).brightness == Brightness.dark
            ? fontStyle.countMsg
            : fontStyle.labelBlack,
...
class DestinationPhone extends StatelessWidget {
  int index;
  DestinationPhone({
    Key? key,
    required this.index,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextField(
        keyboardType: TextInputType.number,
        onChanged: (value) =>
            model.packageInfo.destinationDetails[index].number = value,
        cursorColor: colors.main,
        style: Theme.of(context).brightness == Brightness.dark
            ? fontStyle.countMsg
            : fontStyle.labelBlack,
